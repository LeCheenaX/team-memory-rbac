...
- local filesystem CAS and the project-dedicated test object-store CAS volume. The test maintenance runner mounts that volume and invokes the same TypeScript core module to clear it.
